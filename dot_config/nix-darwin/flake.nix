{
  ...
  inputs = {
    ...
    homebrew-mlx-serve = {
      url = "github:ddalcu/mlx-serve";
      flake = false;
    };
    homebrew-omlx-cask = {
      url = "github:pnavais/omlx-cask";
      flake = false;
    };
    homebrew-aerion-cask = {
      url = "github:pnavais/aerion-cask";
      flake = false;
    };
      ...
      configuration =
        { pkgs, config, ... }:
        {
          ...
          homebrew = {
            ...
            # Enable forcing updates for non latest casks
            #greedyCasks = true;
          };
          ...
          nix-homebrew.darwinModules.nix-homebrew
          {
            nix-homebrew = {
              ...
              taps = {
                ...
                "homebrew/homebrew-jundot-omlx" = homebrew-jundot-omlx;
                "homebrew/homebrew-pnavais-omlx" = homebrew-omlx-cask;
